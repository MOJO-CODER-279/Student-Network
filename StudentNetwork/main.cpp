...
void findNHop(int friendships[][2], int friendshipCount, int count, int studentIndex, int N, char studentData[], int studentIndices[]) {
...
int main() {
    ...
    char line[256];
    fin.getline(line, sizeof(line)); // Skip header line
